...
class TestChain(object):
    ...
    def test_aic_posterior_dependence(self):
        ...
        assert aics[0] == 0
        expected = 2 * np.log(2)
        assert np.isclose(aics[1], expected)
    ...
    def test_bic_posterior_dependence(self):
        ...
        assert bics[0] == 0
        expected = 2 * np.log(2)
        assert np.isclose(bics[1], expected)
    ...
    def test_bic_data_dependence(self):
        ...
        assert np.isclose(bics[0], expected)
