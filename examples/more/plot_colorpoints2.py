...
data = rng.multivariate_normal(rng.normal(size=4), np.dot(cov, cov.T), size=100000)
cov = 1 + 0.5 * rng.normal(size=(4, 4))
data2 = rng.multivariate_normal(4 + rng.normal(size=4), np.dot(cov, cov.T), size=100000)
